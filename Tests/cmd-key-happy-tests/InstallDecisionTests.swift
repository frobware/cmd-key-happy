...
final class InstallDecisionTests: XCTestCase {
    private let team = SigningIdentity(teamIdentifier: "ABCDE12345", signingIdentifier: "com.frobware.cmd-key-happy")
    private let otherTeam = SigningIdentity(teamIdentifier: "ZZZZZ99999", signingIdentifier: "com.frobware.cmd-key-happy")
    private let adHoc = SigningIdentity(teamIdentifier: nil, signingIdentifier: "com.frobware.cmd-key-happy")
